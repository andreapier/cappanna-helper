...
public static class PredicateBuilder
{
    ...
    {
        var secondBody = expr2.Body.Replace(expr2.Parameters[0], expr1.Parameters[0]) ?? throw new InvalidOperationException($"Cannot create Or expression");
        return Expression.Lambda<Func<T, bool>>(Expression.OrElse(expr1.Body, secondBody),expr1.Parameters);
    }

    public static Expression<Func<T, bool>> And<T>(this Expression<Func<T, bool>> expr1, Expression<Func<T, bool>> expr2)
    {
        var secondBody = expr2.Body.Replace(expr2.Parameters[0], expr1.Parameters[0]) ?? throw new InvalidOperationException($"Cannot create And expression");
