...
import Api from "api";
import { signinCompleted, signalApiError, loadingChanged, loadStandsListRequested } from "actions";
import { SIGNIN_REQUESTED } from "actions/types";
import localforage from "localforage";

const saveUserData = (userData) => localforage.setItem("userData", userData).catch((err) => console.error("Error saving user data in local storage", err));
