...
export function setOrderCustomer(customer) {
  return { type: SET_ORDER_CUSTOMER, payload: customer };
}
...
export function orderDetailsAggregationCompleted() {
  return { type: ORDER_DETAILS_AGGREGATION_COMPLETED };
}
