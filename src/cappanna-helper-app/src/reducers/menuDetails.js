import { LOAD_MENU_DETAILS_COMPLETED, MENU_DETAILS_CHANGED, SIGNOUT_COMPLETED } from "actions/types";

const initialState = [];

const calculateUnitsInStock = (unitsInStock) => (unitsInStock === null || unitsInStock === undefined ? Infinity : unitsInStock < 0 ? 0 : unitsInStock);
