import { LOAD_NOTIFICATIONS_LIST_COMPLETED, ORDER_CREATED, ORDER_CHANGED, ORDER_PRINTED, ORDER_DELETED, SIGNOUT_COMPLETED } from "actions/types";
...
const notification = (state = initialState, action) => {
    switch (action.type) {
        ...
        case ORDER_CHANGED:
            const found = state.find((n) => n.type === "ORDER" && n.orderId === action.payload.id);
