...
import { orderCreated, orderChanged, orderPrinted, orderDeleted, menuDetailChanged } from "actions";
...
class SignalR {
  constructor(dispatch) {
    ...
    this.menuHubConnection.on("NotifyMenuDetailChanged", data =>
      this.dispatch(menuDetailChanged(data))
    );
  }
