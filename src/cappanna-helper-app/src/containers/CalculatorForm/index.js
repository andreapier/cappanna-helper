        ...
        return (
            <form onSubmit={this.handleSubmit}>
                <Grid>
                    ...
                    <ItemGrid xs={12} md={4}>
                        <TextField name="seats" fullWidth label="Coperti" type="number" onChange={this.setSeats} value={this.state.seats} />
                    </ItemGrid>
                    ...
                    <ItemGrid xs={12} md={6}>
                        <TextField name="chChange" fullWidth label="Resto" type="number" readOnly value={this.props.chChange} normalize={this.formatAmount} />
                    </ItemGrid>
                </Grid>
            </form>
        );
