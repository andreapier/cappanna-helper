...
class Notifications extends Component {
    ...
    render() {
        return <NotificationsComp notifications={this.props.notifications} printRequested={this.props.printRequested} />;
    }
...
const mapDispatchToProps = (dispatch) => {
    return {
        loadNotificationsListRequested: () => dispatch(loadNotificationsListRequested()),
