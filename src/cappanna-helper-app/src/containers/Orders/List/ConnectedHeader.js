...
const mapStateToProps = (state) => {
    return {
        ...
        showToggleOrdersListFilterByStand: state.user.roles.some((r) => r === "admin" || r === "cashier"),
        showToggleOrdersListFilterByStatus: state.user.roles.some((r) => r === "admin")
    };
};
...
const mapDispatchToProps = (dispatch, ownProps) => {
    return {
        ...
        toggleOrdersListFilterByUser: () => dispatch(toggleOrdersListFilterByUser()),
        toggleOrdersListFilterByStand: () => dispatch(toggleOrdersListFilterByStand()),
        toggleOrdersListFilterByStatus: () => dispatch(toggleOrdersListFilterByStatus())
    };
};
